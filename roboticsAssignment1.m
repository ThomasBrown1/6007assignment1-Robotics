...
Box7 = uicontrol('style','pushbutton','string','Calculate x,y,z coordinates','position', [100 50 100 10])
Box7.Callback = @box4modified;
...
Box14 = uicontrol('style','text','string','X coordiante','position', [10 10 100 10])
Box15 = uicontrol('style','text','string','Y Coordinate','position', [50 10 100 10])
Box16 = uicontrol('style','text','string','Z coordinate','position', [100 10 100 10])