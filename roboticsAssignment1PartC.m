...
function pushButtonPressed (src,event) %% Causes the below event to trigger upon pressing the GUI pushbutton
    ...
    Theta4=str2num(box4)+90; %% Converts the value inputted into box4 on the GUI from a string to a number for mathmatical manipulation
    Theta5=str2num(box5)-90; %% Converts the value inputted into box5 on the GUI from a string to a number for mathmatical manipulation
    ...
    NotAlpha3 = 180; %% Here the value for rotation around the X axis for joint 1 has been assigned to the varaible NotAlpha1
    NotAlpha4 = 0;  %% Here the value for rotation around the X axis for joint 1 has been assigned to the varaible NotAlpha1
    ...
    Base = [1 0 0 0; 0 cosd(180) -sind(180) 0; 0 sind(180) cosd(180) 0; 0 0 0 1]; %% Defines the position of the baseframe of the Yakasawa GP8 robot
